    ...
    public function inserting($categry_id, $name, $visible) {
        ...
        try {
            ...
            if($con){
                ...
                $result->bindValue(":category_id", $categry_id, PDO::PARAM_INT);
                $result->bindValue(":name", $name); // string value can be concatenated
                $result->bindValue(":visible", $visible, PDO::PARAM_INT);
